    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(cmd.equalsIgnoreCase(null)){
                request.setAttribute("msn", "Usuario Não Existe!!");
                request.getRequestDispatcher("ExibeUsuarios").forward(request, response);
            }else {
                  int id = Integer.parseInt(cmd);
                  dao.remove(id);
                  request.setAttribute("msn", "Usuario Excluído!!");
                  request.getRequestDispatcher("ExibeUsuarios").forward(request, response);
            }
